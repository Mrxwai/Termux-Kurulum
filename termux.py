...
Önemli: Lütfen, önce paket kurulumları bölümünden termux için gerekli olan paketlerin kurulumunu yapınız!
    ...
    if secim == "1":#Bilgi Toplama
        ...
        if ony == "1":
            ...
            os.system("cd $HOME && git clone https://github.com/noob-hackers/grabcam && cd grabcam && pip install lolcat && cd $HOME && cd Mrxwai && python termux.py")
            ...
            os.system("cd $HOME && apt install perl wget gzip make && wget https://sno.phy.queensu.ca/~phil/exiftool/Image-ExifTool-11.19.tar.gz && gzip -dc Image-ExifTool-*.tar.gz | tar -xf -&& perl Makefile.PL && make install && cd Mrxwai && python termux.py")

        elif ony == "8":
            os.system("cd $HOME && git clone https://github.com/laramies/theHarvester && cd theHarvester && python3 -m pip install pipenv && python3 -m pip install pipenv && cd $HOME && cd Mrxwai && python termux.py")
        ...
        if s == "1":
            ...
            os.system("cd $HOME && git clone https://github.com/TheSploit/Sploit-Malicious && cd Sploit-Malicious && pip2 install -r requirements.txt && cd $HOME && python termux.py ")

        elif s == "3":
            os.system("cd $HOME && git clone https://github.com/Lexiie/Termux-Apktool && cd Termux-Apktool && dpkg -i apktool_2.3.4_all.deb && cd $HOME && cd Mrxwai && python termux.py")
        ...
        opt = input(yesil+'\n\n [+] İşlem No: ')
        if opt == "1":
            os.system("cd $HOME && git clone https://github.com/khansaad1275/termux-ohmyzsh && cd termux-ohmyzsh && chmod +x * && cd $HOME && cd Mrxwai && python termux.py ")
        elif opt == "99":
            arac_kurulumları()
        elif opt == "00":
            ana_menu()
